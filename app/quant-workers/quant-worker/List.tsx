      ...
      <div className="flex items-center justify-between p-4 border border-borderColor bg-bgColor rounded-xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={additionRef}>
            ...
            <div
              className={`absolute w-[184px] bg-bgColor border border-bgHover p-2 rounded-xl z-50 transition-opacity duration-300 ease-in-out bottom-0 translate-y-full right-0
