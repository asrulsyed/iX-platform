...
import { FaAngleDown, FaListUl, FaPlus } from "react-icons/fa6"
  ...
  return (
    <div className="flex gap-3 w-full">
      ...
      <div className="hidden lg:flex items-center justify-between rounded-md border border-borderColor p-1 h-10 min-w-[88px] max-w-[88px] bg-bgColor">
        <button 
        className={`w-full h-full flex justify-center items-center rounded-sm ${align === 'card' ? 'bg-bgHover' : 'bg-transparent'}`}
      ...
      <div className="relative">
        <button 
          ...
          onClick={() => router.push('/quant-workers/quant-worker/create')}
        >
