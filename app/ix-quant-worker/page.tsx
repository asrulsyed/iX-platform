...
const ixQuantWorker = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-full gap-6 bg-black">
      ...
      <button type="button" className="inline-flex items-center justify-center h-12 gap-2 px-3 text-base font-medium transition-colors duration-300 ease-in-out rounded whitespace-nowrap focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 bg-fontHover hover:bg-[#dbe6f0e5]">
        Deploy New Worker
